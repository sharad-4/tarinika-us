...
window.addEventListener('load', function() {
    ...
    var productEl = document.querySelector("[data-product-form]");
      if(typeof productEl === "object" && productEl !== null) {
...
var product_has_available_variants = Array.isArray(product_available_variants) && product_available_variants.length > 0;
...
if ($product_form) {
  ...
  // Handle the case where $product_form is not found
  console.error("Product form is not found.");
}
})
